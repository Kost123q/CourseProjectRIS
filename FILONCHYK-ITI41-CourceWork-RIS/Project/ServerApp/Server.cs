...
namespace ServerApp
{
	public class Server
	{
		...
		string GetIndexPage()
		{
			string response = File.ReadAllText("C:\\Users\\Asus\\Desktop\\KYRSACH\\FINALMESSI\\Project\\index.html");
